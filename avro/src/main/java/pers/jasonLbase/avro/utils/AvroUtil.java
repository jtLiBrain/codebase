...
public class AvroUtil {
	 ...
	 * @throws IOException
	 */
	public static <T> byte[] encodeAsSpecificDatum(T datum, Schema schema) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static byte[] encodeAsGenericRecord(GenericRecord datum, Schema schema) throws IOException {
		ByteArrayOutputStream outStream = new ByteArrayOutputStream();
		Encoder encoder = EncoderFactory.get().binaryEncoder(outStream, null);
